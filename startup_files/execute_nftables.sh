...
docker exec -d clab-igp-h1 bash -c "./etc/nftables.sh"
docker exec -d clab-igp-h2 bash -c "./etc/nftables.sh"
docker exec -d clab-igp-h3 bash -c "./etc/nftables.sh"
docker exec -d clab-igp-h4 bash -c "./etc/nftables.sh"
